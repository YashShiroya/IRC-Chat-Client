          ...
          char *argv[] )
{
	...
	//GtkWidget * vbox_messages;
	
	//vbox_messages = gtk_vbox_new(TRUE,0);
	//gtk_container_add (GTK_CONTAINER (window), vbox_messages);
	//vbox_entry = gtk_vbox_new (TRUE, 0);
	//
    
    //gtk_container_add(GTK_CONTAINER(window), contain_all);
    // Create a table to place the widgets. Use a 7x4 Grid (7 rows x 4 columns)
    GtkWidget *table = gtk_table_new (4, 8, TRUE);
    ...
    gtk_widget_show (send_button);
       	...
       	//Room Code____________________________________________________________________________________________________
    ...
    gtk_box_pack_start(GTK_BOX(vbox_entry), vbox, TRUE, FALSE, 0);
        
   	
   	//gtk_box_pack_start(GTK_BOX(vbox), label1, TRUE, TRUE, 0);
   	//Rooms End____________________________________________________________________________________________________
   
    
    //gtk_box_pack_start(GTK_BOX(vbox_messages), table, TRUE, FALSE, 0);
    gtk_widget_show (vbox);
    gtk_widget_show(vbox_entry);
    gtk_widget_show (table);
    gtk_widget_show(vbox_messages);
    gtk_widget_show(contain_all);
